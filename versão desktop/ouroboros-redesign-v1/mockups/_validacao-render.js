...
montarShell({
  ...
  breadcrumb: ['Ouroboros', 'Documentos', 'Validação por Arquivo'],
  acoes: [
    { label: 'Exportar CSV', icon: 'download', onClick: "toast('CSV de divergências exportado · 47 linhas')" },
    { label: 'Salvar progresso', icon: 'check', primary: true, onClick: "toast('Progresso salvo · VALIDAÇÃO-CSV-01')" },
  ],
});
