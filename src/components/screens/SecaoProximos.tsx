...
export function SecaoProximos() {
  ...
  // R-HOME-4a self-hide: no feed adaptativo a secao so aparece quando ha
  // itens. Loading, erro e lista vazia retornam null (a antiga caixa
  // "Nada nas próximas horas." deixou de existir na home). A tela
  // dedicada /agenda mantem seu proprio empty state.
  if (loading || error || itens.length === 0) return null;
