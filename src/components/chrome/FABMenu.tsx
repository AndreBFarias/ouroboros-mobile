...
import { useSafeBottomMargin, FAB_ZONA_ALTURA } from './safeBottom';
...
// R-HOME-4f: o valor agora vem de FAB_ZONA_ALTURA (safeBottom.ts) para
// que a reserva de paddingBottom das telas nao divirja do tamanho real
// do FAB.
const FAB_SIZE = FAB_ZONA_ALTURA;
