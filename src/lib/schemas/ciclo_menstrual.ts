...
//  - data_inicio: data de inicio do ciclo atual; null antes do primeiro
//    registro real ou em dias que nao marcam novo ciclo (apenas
...
//    nao houver registro de sintomas.
...
//  - Tom sobrio absoluto: schema nao traz campo de "atrasou" nem
//    "anomalia"; o calendario e leitura passiva.
//  - Comentarios sem acento (convencao shell/CI).
import { z } from 'zod';
import { PessoaAutorSchema } from '@/lib/schemas/pessoa';

// Data YYYY-MM-DD (sem hora; ciclo e snapshot diario, nao um evento).
const DataYmd = z
  .string()
...
export const CicloMenstrualSchema = z.object({
  ...
  // Data de inicio do ciclo atual; null antes do primeiro registro
  // real ou quando o dia nao marca um novo ciclo.
...
// proximo do schema para evitar drift entre tela e modelo. Acentuacao
...
// As cores casam com docs/BRIEFING.md secao 3 e M14.5-spec secao 2.
