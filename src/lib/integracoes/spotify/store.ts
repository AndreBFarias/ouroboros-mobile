...
export const useSpotifyAuth = create<SpotifyAuthState>()(
  persist(
    ...
    }),
    {
      ...
      // em ContaSpotify (foi o caso de `scope`) hidrata `undefined` em
...
export function mergeSpotifyPersistido(
  persistedState: unknown,
  currentState: SpotifyAuthState
): SpotifyAuthState {
