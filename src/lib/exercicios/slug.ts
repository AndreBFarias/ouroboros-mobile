// Helper de slug para nome de arquivo do exercicio. O path canonico
...
//
// Acentos sao removidos via NFD/diacriticos para preservar slug
// puramente ASCII. Espacos e nao-alfanumericos viram '-', multiplos
// '-' colapsam em um. Limite mais generoso que slugifyEvento (32 vs
// 24) porque nomes de exercicio podem ser compostos (rosca-direta-
...
// Sempre retorna string nao-vazia (fallback 'exercicio').
