...
// caller cópia para o Vault via SAF.
//
// Justificativa de PDF único: usuário que captura recibo multipágina
// quer 1 arquivo, não N. Tambem reduz número de .md companions.
import * as Print from 'expo-print';

export interface MultipagePdfResultado {
  // Path absoluto file:// no cache do app. Caller decide se cópia
  // para inbox/financeiro/nota/ via StorageAccessFramework.
  uri: string;
}
