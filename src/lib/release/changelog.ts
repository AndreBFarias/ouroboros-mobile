// Mini-changelog amigavel para a tela Sobre. Nao e import bruto de um
// changelog tecnico interno: aqui o texto e humanizado, em sentence
// case PT-BR completa, sem jargao tecnico interno (ids de sprint,
// paths). Cada entrada lista a versao publica, a data ISO e ate 5
// mudancas percebidas pelo usuario final.
//
...
// da lista visivel da tela Sobre.
//
// Regra -1 anonimato: nenhuma entrada tem atribuicao a ferramenta ou
// pessoa. Texto descreve a feature do ponto de vista do usuario.
