...
describe('EmocaoChips modo trigger', () => {
  it('renderiza os 6 chips negativos com acento PT-BR', () => {
    const { getByLabelText } = render(
      <EmocaoChips modo="trigger" value={[]} onChange={() => undefined} />
    );
  ...
  it('clique em chip dispara onChange com slug snake_case', () => {
    ...
    const { getByLabelText } = render(
      <EmocaoChips modo="trigger" value={[]} onChange={onChange} />
    );
...
describe('EmocaoChips modo vitoria', () => {
  it('renderiza os 6 chips positivos com acento PT-BR', () => {
    const { getByLabelText } = render(
      <EmocaoChips modo="vitoria" value={[]} onChange={() => undefined} />
    );
  ...
  it('nao expoe chips negativos quando modo eh vitoria', () => {
