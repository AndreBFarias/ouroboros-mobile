...
//
// Como rodar (automacao de browser):
//   1. ./gauntlet.sh
//   2. Carregar a automacao de browser.
...
export default async function caseWcagAudit(
  ...
  try {
    ...
    // A automacao deve serializar a string da rota dentro do loop;
    ...
    for (const rota of ROTAS) {
      ...
      try {
        ...
        // diretorio pode nao existir; criado sob demanda.
      }
    }
