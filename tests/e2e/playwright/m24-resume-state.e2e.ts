...
export default async function caseM24(
  ...
  try {
    ...
    const path =
      'docs/validacao-gauntlet-2026-05-03/screenshots/M24/A-fail-redirect-home.png';
    ...
    return {
      ...
      aspecto,
      status: 'PASS',
      detalhe: 'redirecionou para /memoria',
      screenshots,
    };
  } catch (err) {
    return {
