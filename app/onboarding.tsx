...
// Frame 4: Seed opcional (R-HOME-4e). Oferece plantar o 1o card real
//          da Tela Hoje -- mini humor ou mini tarefa -- com "Pular"
//          bem visivel. Nao forca; nao marca concluido.
// Frame 5: Tudo pronto, <nome>. Mostra resumo "N permissoes
//          concedidas". Botao "Comecar" marca concluido e vai a home.
//
...
import { SeedOpcionalOnboarding } from '@/components/onboarding/SeedOpcionalOnboarding';

// R-HOME-4e: Frame 4 e o seed opcional (penultimo); "Tudo pronto"
// passa a ser o Frame 5 (ultimo), preservando o fecho testado.
type FrameId = 0 | 1 | 2 | 3 | 4 | 5;
...
export default function Onboarding() {
  ...
  const avancar = () => setFrame((f) => (f >= 5 ? 5 : ((f + 1) as FrameId)));
      ...
      <View style={{ flex: 1, paddingTop: spacing.xl }}>
        ...
        >
          <FrameAnim frameKey={frame}>
            ...
            {frame === 4 && (
              <SeedOpcionalOnboarding onConcluir={avancar} />
            )}
            {frame === 5 && (
              <Frame5Concluir
                nomeA={nomeA}
...
// Frame 5 (ex-Frame 4, movido em R-HOME-4e): fecho "Tudo pronto".
// Botao "Comecar" chama handleConcluir -> marcarConcluido + replace('/').
function Frame5Concluir({
  nomeA,
  nomeB,
