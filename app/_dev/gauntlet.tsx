// M-GAUNTLET: dashboard interativo. Em web + GAUNTLET_ATIVO, expoe
// botoes para seed/reset/abrirMenu/fecharMenu, lista de rotas para
// navegacao manual via toque, e painel JSON com estado atual auto-
// refresh a cada 500ms. Tudo do dashboard usa diretamente
// window.__gauntlet (instalado em _layout.tsx) -- assim o
