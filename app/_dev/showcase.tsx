...
// Em modo dev, e possivel rolar a pagina e capturar
// screenshots das telas em sequencia via automacao de browser.
//
...
// Mapa das telas canonicas do app. Numero segue a numeracao de
// telas do design system (docs/BRIEFING.md).
