...
| `[wip]` | M-REVALIDACAO-M20-M28 | Re-valida 11 sprints concluídas (M20-M28) via Gauntlet com 1 E2E por sprint; gera relatório consolidado em `docs/validacao-gauntlet-2026-05-03/RELATORIO.md`. Bugs descobertos viram corretivas separadas. **Bloqueia M29 até zerar FAIL**. Depende de M-GAUNTLET fechada | — | — | 4-6h | `M-REVALIDACAO-M20-M28-spec.md` |
