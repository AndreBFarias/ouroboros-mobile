...
| R-BUNDLE-LUCIDE-RESHIM | Fix app/index.tsx:29 bypass shim icons + ESLint no-restricted-imports lucide-react-native | fix | P1 | ~1h | `R-BUNDLE-LUCIDE-RESHIM-spec.md` (derivada R-BUNDLE-SIZE-AUDIT, ganho -650KB Hermes, pre-requisito M41) |
| R-ADR-LIMITE-BUNDLE-V2 | ADR-0027 com novo limite 10.5MB (vs 8.85MB anterior) justificativa Onda Q/R/3J/3K | docs+ADR | P1 | ~30min | `R-ADR-LIMITE-BUNDLE-V2-spec.md` (derivada R-BUNDLE-SIZE-AUDIT, pre-requisito M41) |
