...
- [ ] **GitHub Pages habilitado apontando para `public/` em `main`.**
  ...
  ```bash
  curl -sf https://<github-user>.github.io/ouroboros-mobile/privacy.html | head -5
  curl -sf https://<github-user>.github.io/ouroboros-mobile/terms.html | head -5
  ```
...
- [ ] **URLs de política e termos cadastradas no Google Cloud Console.**
  ...
  - Política de privacidade: `https://<github-user>.github.io/ouroboros-mobile/privacy.html`
  - Termos de uso: `https://<github-user>.github.io/ouroboros-mobile/terms.html`
