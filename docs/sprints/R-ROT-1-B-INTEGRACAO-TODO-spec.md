...
```
DECISAO:    (dono, 2026-07-29) Aprovado para execução. A investigação de 2026-07-29
            confirmou que os 6 símbolos que o lint acusa em `app/todo.tsx`
            (`silenciarSugestaoTarefa`, `SugestaoAlarmeTarefa`, `calcularSilenciarAte`,
            `calcularSugestaoAlarme`, `estaSilenciado`, `normalizarTituloFamilia`) não
            são resíduo: são uma feature completa, com 88 testes verdes, à qual falta
            apenas o JSX.
```
...
- agente.md, ROADMAP.md, CHANGELOG.md, STATE.md, VALIDATOR_BRIEF.md, Checkpoint.md.
