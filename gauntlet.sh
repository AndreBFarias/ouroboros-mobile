...
# se rodado de worktrees/<id>/, exporta EXPO_ROUTER_APP_ROOT,
...
# (worktrees/<id>/), node_modules e env.json sao symlinks para
...
# worktrees/agent-XYZ/... -> Metro crasha pos-bundle sem bindar
